...
/// din `ActivationSheet.swift`. Fail-open: fără conexiune sau `productID`
/// lipsă, se folosește `fallbackBasePrice` (5 €, valoarea hardcodată
/// anterior, preț promoțional beta).
final class PricingChecker: ObservableObject {
    ...
    private static let productID = "gdc-vault"
    static let fallbackBasePrice: Double = 5
